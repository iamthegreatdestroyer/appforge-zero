...
export class BuildPipelinePersistence {
   ...
   */
  static async updateBuildProgress(id: string, progress: number): Promise<void> {
    const manager = getDatabaseManager();
...
export class BuildPipelineWithPersistence extends BuildPipelineService {
  ...
  override async updateProgress(jobId: string, progress: number): Promise<void> {
...
export class DistributionWithPersistence extends DistributionService {
  override async publishApp(appId: string, channel: string, config: any): Promise<boolean> {
  ...
  override async recordSales(appId: string, channel: string, metrics: any): Promise<void> {
