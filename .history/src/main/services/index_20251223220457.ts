...
// ============================================================================
// PHASE 6: SERVICE INTEGRATION & ORCHESTRATION EXPORTS
// ============================================================================

// Base service and utilities
export { BaseService, ServiceConfig as Phase6ServiceConfig, ServiceContext, OperationResult, ServiceMetrics } from './base.service';
export { createServiceLogger } from './base.service';
...
export {
  ...
  ServiceRegistry as Phase6ServiceRegistry,
...
// Payment service
export { PaymentService, Transaction, createPaymentService } from './payment.service';

// Trend service
export { TrendService, Trend, createTrendService } from './trend.service';

// Build service
export { BuildService, Build, createBuildService } from './build.service';
