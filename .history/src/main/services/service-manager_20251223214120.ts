...
import { BaseService, ServiceConfig, ServiceContext, createServiceLogger } from './base.service';
...
export class ServiceManager {
  ...
  constructor(config: ServiceManagerConfig) {
    ...
    this.workflowEngine = config.workflowEngine || new WorkflowEngine(this.eventBus);
  }
  ...
  async executeServiceOperation<T>(
    ...
    throw new Error(`Operation not implemented: ${serviceName}.${operationName}`);
  }
 ...
 */
export function createServiceManager(config: ServiceManagerConfig): ServiceManager {
 ...
 */
export function initializeServiceManager(config: ServiceManagerConfig): ServiceManager {
...
export function getServiceManager(): ServiceManager {
  if (!serviceManagerInstance) {
    throw new Error('ServiceManager not initialized. Call initializeServiceManager first.');
  }
  return serviceManagerInstance;
}
