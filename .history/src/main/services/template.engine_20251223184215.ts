      ...
      morphTransformation: {
        ...
        narrative: {
          theme: {
            ...
            conflicts: ['Zero-G mishaps', 'alien encounters', 'equipment failures'],
...
class TemplateEngine implements TemplateEngineService {
  ...
  async validateTemplate(
    ...
    if (!template.morphTransformation) {
      ...
      if (!morphTransformation.characters || Object.keys(morphTransformation.characters).length === 0) {
        errors.push({
      ...
      if (!morphTransformation.settings || Object.keys(morphTransformation.settings).length === 0) {
        errors.push({
      ...
      if (!morphTransformation.narrative || Object.keys(morphTransformation.narrative).length === 0) {
        warnings.push({
