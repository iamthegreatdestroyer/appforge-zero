    ...
    <div className="trend-detail">
      ...
      <div className="trend-detail__section">
        ...
        <p className="trend-detail__description">
          {trend.keyword} is currently {trend.velocity > 0 ? 'gaining' : 'losing'}{' '}
          momentum with a search volume of {trend.volume}%. This trend is being
          tracked from {trend.source === 'google' ? 'Google Trends' : 'Reddit'}.
        </p>
      </div>
          ...
          <div className="trend-detail__insight">
            ...
            <div>
              ...
              <p className="trend-detail__insight-text">
                This trend shows strong growth potential. Consider building an app that
                addresses a gap in the current market.
              </p>
            </div>
          </div>
          <div className="trend-detail__insight">
            ...
            <div>
              ...
              <p className="trend-detail__insight-text">
                Moderate competition. Act soon to capture market share before saturation.
              </p>
            </div>
          </div>
          <div className="trend-detail__insight">
            ...
            <div>
              ...
              <p className="trend-detail__insight-text">
                Premium features, ads, and in-app purchases are viable monetization
                strategies.
              </p>
            </div>
          </div>
