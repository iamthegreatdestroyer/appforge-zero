    ...
    <div data-testid="page-dashboard" className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="mt-2 text-3xl font-bold text-gray-900">{templates.length}</div>
        </div>
        <div className="bg-white rounded-lg shadow p-6">
          <div className="text-sm font-medium text-gray-500">Total Builds</div>
          <div className="mt-2 text-3xl font-bold text-gray-900">{builds.length}</div>
        </div>
        <div className="bg-white rounded-lg shadow p-6">
          <div className="text-sm font-medium text-gray-500">Active Trends</div>
          <div className="mt-2 text-3xl font-bold text-gray-900">{trends.length}</div>
        </div>
        <div className="bg-white rounded-lg shadow p-6">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="space-y-2">
          {builds.slice(0, 5).map((build) => (
            <div key={build.id} className="flex items-center justify-between py-2 border-b">
