...
const TrendsPage: React.FC = () => {
  ...
  const filteredTrends = trends.filter((t) => {
    if (
      filters.search &&
      !t.keyword.toLowerCase().includes(filters.search.toLowerCase())
    )
      return false;
    if (filters.sources.length > 0 && !filters.sources.includes(t.source))
      return false;
    return true;
  });
  ...
  return (
    <div data-testid="page-trends" className="space-y-6">
      ...
      {showScanDialog && (
        <div
          data-testid="scan-options-dialog"
      ...
      <div className="flex gap-4">
        ...
        <select
          ...
          onChange={(e) =>
            setFilters({
              sources: e.target.value ? [e.target.value as any] : [],
            })
          }
          ...
          >
            <div className="flex justify-between items-start">
              ...
              <div className="text-right">
                ...
                <div
                  className={`text-sm ${trend.velocity > 0 ? "text-green-600" : "text-red-600"}`}
                >
                  {trend.velocity > 0 ? "↑" : "↓"}{" "}
